...
from utils.queries import MEDIA_QUERY, CHARACTER_QUERY
from utils.ui import build_media_embed, build_character_embed, PaginationView
...
class Search(commands.Cog):
    ...
    async def anime(self, interaction: discord.Interaction, anime_name: str):
        # We pass 'anime_name' to the generic search
